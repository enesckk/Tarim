...
export function ProducerCta({ onTabClick, onOpenModal }: ProducerCtaProps) {
  ...
  return (
    ...
    >
      {/* Brand Logo Container: Clean static logo and text */}
      <div className="pointer-events-auto flex items-center gap-2 sm:gap-3 select-none shrink-0">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5 whitespace-nowrap">
          <span
            className={cn(
              'text-[13px] sm:text-[17px] md:text-[19px] font-sans font-extrabold tracking-[0.2em] uppercase leading-none transition-colors duration-300',
          ...
          <span className={cn('font-extrabold text-xs sm:text-base opacity-90 transition-colors duration-300', isLight ? 'text-[#3D6436]' : 'text-[#6B9E5E]')}>•</span>

          <span
            className={cn(
              'text-[11px] sm:text-[14px] md:text-[15.5px] font-sans font-bold tracking-[0.22em] uppercase leading-none transition-colors duration-300',
      ...
      <div className="pointer-events-auto flex items-center gap-2 sm:gap-3 shrink-0">
        ...
        <button
          ...
          className={cn(
            ...
            isLight
              ? 'border-gray-300 bg-white/90 text-[#1E1E1E] hover:border-[#3D6436] hover:text-[#3D6436]'
