...
function SidebarNavComponent({
  ...
  return (
    <>
      ...
      <aside className="hidden lg:flex fixed lg:left-8 xl:left-10 top-0 bottom-0 z-50 flex-col justify-between pt-12 pb-20 pointer-events-none gpu-accelerated transition-opacity duration-300">
